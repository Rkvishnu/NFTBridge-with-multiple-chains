...
import { bscChain, polyChain, ethChain, bscTest, ethTest, polyTest } from './chainchange';
...
const droptheme = createTheme({
  ...
  theme: {
    ...
    colors: {
      primaryLight: '#00000000',
      primaryLightHover: '#00000000',
      primaryLightActive: '#00000000',
      primaryLightContrast: '#00000000',
      primary: '#1F51FF40',
      primaryBorder: '#00000000',
      primaryBorderHover: '#00000000',
      primarySolidHover: '#00000000',
...
export default function sourcebridge() {
  ...
  return (
    <NextUIProvider theme={droptheme}>
      ...
      <Text css={{ mb: '20px' }} h4>Source</Text>
